...
export function translate_en_ca(key) {
    switch (key) {
        case "lang.en_us":
        ...
        case "lang.switch.fr":
            return "Switched language to French";
        case "lang.switch.sp":
        ...
        case "help.text":
            return stripIndents`
                ...
                /flavor - Ever wondered what flavour you are? Find out now.
        ...
        case "flavor.flavor":
            return random_string([
                // Real flavors (14)
                ["Grape Flavoured", "#ab339f"],
                ["Strawberry Flavoured", "#db2323"],
                ["Blueberry Flavoured", "#243fd6"],
                ["Lemon Flavoured", "#edfa7d"],
                ["Sour Flavoured", "#a8db74"],
                ["Sweet Flavoured", "#f78172"],
                ["Blueberry Flavoured", "#3f3dd9"],
                ["Avacado Flavoured", "#1c613b"],
                ["Not Flavoured :cry:", "#3b6fd1"],
                ["Cotton Candy Flavoured", "#87eaf5"],
                ["Apple Flavoured", "#c41b1b"],
                ["Banana Flavoured", "#e6da32"],
                ["Cherry Flavoured", "#7d040a"],
                ["Cinnamon Flavoured", "#913f04"],
                // Unusual flavors (15)
                ["Green Flavoured", "#24d63f"],
                ["**~~VOID~~** Flavoured", "#000000"],
                ["Heaven Flavoured", "#ffffff"],
                ["War Crime Flavoured", "#ff0000"],
                ["Sky Flavoured", "#5fc5ed"],
                ["Weed Flavoured", "#31f76a"],
                ["Shart Flavoured", "#5e2d0f"],
                ["Milf Flavoured", "#a221bf"],
                ["Ronald Flavoured :beronald:", "#000000"],
                ["Gasoline Flavoured", "#a9d9ae"],
                ["Cum Flavoured", "#d4d4d4"],
                ["Breast Milk Flavoured", "#d4d4d4"],
                ["Blood Flavoured", "#941212"],
